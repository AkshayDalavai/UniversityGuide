...
public class CommentsDto {
	...
	public CommentsDto(int id, UserDto user, PostsDto posts, String commentsContent, int likesCount,
			boolean isAnonymous, Date createdDate, Date lastModifiedDate, String createdBy) {
		super();
		this.id = id;
		this.user = user;
		this.posts = posts;
	...
	public String toString() {
		return "CommentsDto [id=" + id + ", user=" + user + ", posts=" + posts + ", commentsContent=" + commentsContent
				+ ", likesCount=" + likesCount + ", isAnonymous=" + isAnonymous + ", createdDate=" + createdDate
